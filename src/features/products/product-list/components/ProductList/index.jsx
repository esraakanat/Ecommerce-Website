...
import { useQueryProducts } from "../../../services/queryProducts";
...
export default function ProductsList({ searchQuery = null,  initialCategory = null, initialSort = null, initialSale = null,initialPage = null}) {
  ...
  const { data: productsData,  isLoading: productsLoading,  error: productsError, refetch: refetchProducts } = useQueryProducts({
    category: selectedCategory,sortBy,showOffers, page, limit, categories: categoriesData || []});
  ...
  const handleCartToggle = (product, e) => {
    ...
    if (isInCart(product.id)) {
      ...
      toast.success('Product removed from cart!', { position: "top-right", autoClose: 3000, hideProgressBar: false,closeOnClick: true,
        pauseOnHover: true,draggable: true,});
    } else {
      addToCart(product);
      toast.success('Product added to cart successfully!', {  position: "top-right", autoClose: 3000, hideProgressBar: false, closeOnClick: true,
       pauseOnHover: true, draggable: true, });
    }
  };
