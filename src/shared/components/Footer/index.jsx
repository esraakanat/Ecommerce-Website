            ...
            <div>
              ...
              <div className="relative group ">
                ...
                <button className="absolute right-2 top-1/2 transform -translate-y-1/2 p-2 rounded-lg hover:from-red-600 hover:to-pink-600 transition-all duration-300 group-hover:scale-110">
                  <img src="/images/arrow.svg" alt="send" className="h-4 w-4 text-white" />
                </button>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6">
            <div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div className="w-20 h-20 bg-white rounded-lg p-1 shadow-lg">
                  <img src="/images/qr.png" alt="QR Code" className="w-full h-full object-cover rounded" />
                </div>
                
                {/* App Store Badges */}
                <div className="space-y-3">
                  <div className="transform hover:scale-105 transition-transform">
                    <img src="/images/google play.png" alt="Google Play" className="w-24 h-auto" />
                  </div>
                  <div className="transform hover:scale-105 transition-transform">
                    <img src="/images/appstore.png" alt="App Store" className="w-24 h-auto" />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="pt-6">
              ...
              <div className="flex space-x-4">
                ...
                <a href="#" className="w-10 h-10 bg-black  rounded-full flex items-center justify-center hover:bg-red-500 transition-all duration-300 transform hover:scale-110">
                  <img src="/images/tiwtter.svg" alt="Twitter" className="w-5 h-5" />
                </a>
                <a href="#" className="w-10 h-10 bg-black  rounded-full flex items-center justify-center hover:bg-red-500 transition-all duration-300 transform hover:scale-110">
